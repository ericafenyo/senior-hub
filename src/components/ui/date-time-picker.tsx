...
const TimePickerInput = React.forwardRef<HTMLInputElement, TimePickerInputProps>(
  (
    ...
    const calculateNewValue = (key: string) => {
      /*
       * If picker is '12 hours' and the first digit is 0, then the second digit is automatically set to 1.
...
type DateTimePickerProps = {
   ...
   * For example,
   * This year is 2024,
   * The year dropdown will be 1974 to 2024 which is generated by `2024 - 50 = 1974` and `2024 + 50 = 2074`.
   * */
  yearRange?: number;
  /**
